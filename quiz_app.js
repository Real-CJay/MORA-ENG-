...
function cleanDisplayText(value) {
  ...
  // Smart text formatter: handles multi-line math questions
  ...
  function formatQuestionText(text) {
    ...
    if (lines.length === 1) {
      // Single line — just return as-is (KaTeX handles it)
      return `<span class="q-intro">${text}</span>`;
    }
    // Multi-line: first line is the intro, rest are statements
    const intro = lines[0];
